        ...
        <main className="w-full p-6 flex flex-col gap-3">
            <div className="flex gap-5 items-center">
                {updateCategoryId && <div className="flex">
                    <h3 className="font-bold text-white bg-orange-500 px-4 py-2 rounded-full text-xs">Update</h3>
                </div>}
                {!updateCategoryId && <div className="flex">
                    <h3 className="font-bold text-white bg-green-500 px-4 py-2 rounded-full text-xs">Create</h3>
                </div>}
